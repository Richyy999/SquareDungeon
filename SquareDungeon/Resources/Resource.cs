...
namespace SquareDungeon.Resources
{
    class Resource
    {
        ...
        public const string NOMBRE_CORRUPCION = "corrupcion";
        ...
        public const string DESC_PICARO = "picaro";
        public const string DESC_EXPLORADOR = "explorador";
        public const string DESC_BARBARO = "barbaro";
        ...
        public const string DESC_CORRUPCION = "corrupcion";
